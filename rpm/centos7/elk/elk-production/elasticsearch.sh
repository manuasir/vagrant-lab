...
# Install Logstash
yum install elasticsearch-6.4.1 logstash-6.4.1 -y
...
# Insert the template
curl https://raw.githubusercontent.com/wazuh/wazuh/3.6/extensions/elasticsearch/wazuh-elastic6-template-alerts.json -s | curl -s -XPUT 'http://172.16.1.4:9200/_template/wazuh' -H 'Content-Type: application/json' -d @-
